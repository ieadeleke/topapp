...
const ContactUsPage = () => {
    return (
        <div className="bg-white">
            <Layout>
                <div className="pt-10 px-20 pb-28 max-w-[1814px] mx-auto">
                    <div className="grid grid-cols-3 gap-10 border-b-2 border-solid border-[#DDDDDD] px-5">
                        <div className="border-r-2 border-solid border-[#DDDDDD] pt-14 pb-24">
                            <h4 className="text-[#202020] text-lg mb-8 font-campton">General Enquiries</h4>
                        ...
                        <div className="border-r-2 border-solid border-[#DDDDDD] pt-14 pb-24">
                            <h4 className="text-[#202020] text-lg mb-8 font-campton">Our Office</h4>
                        ...
                        <div className="pt-14 pb-24">
                            <h4 className="text-[#202020] text-lg mb-8 font-campton">Connect With Us</h4>
                    ...
                    <div className="grid grid-cols-1/2 gap-10 items-center">
                        <div>
                            <Image src={LogoImg} alt="logo" className="mb-7" />
                            <h3 className="text-5xl text-dark font-campton md:leading-snug leading-snug">Get in Touch With Pay4it</h3>
                        </div>
                        <div className="border-l-2 border-[#DDDDDD] px-16 py-14">
                            <form action="">
