    ...
    return (
        <div className="bg-dark relative">
            <Layout navPosition="fixed">
                <>
                    <div className="pt-44 pb-20 text-center relative overflow-hidden">
                    ...
                    <div className="z-40 relative bg-white py-20 pb-28 rounded-t-[200px]">
                        <div className="w-[60%] 3xl:w-[57%] 4xl:w-[46%] mx-auto">
                            <h3 className="font-campton text-5xl mb-7 mx-auto text-center leading-tight max-w-[1140px]">
                        ...
                        <div className="w-[80%] 3xl:w-[75%] 4xl:w-[60%] mt-14 w-max-[1150px] mx-auto">
                        ...
                        <div className="grid grid-cols-2 gap-16 3xl:gap-20 4xl:gap-24 items-center mt-28 w-[75%] 3xl:w-[75%] 4xl:w-[60%] w-max-[1320px] mx-auto">
                            <div>
                                <Image src={WomanSmiling} alt="woman smiling" className="max-w-[590px] w-full" />
                            </div>
                            <div>
                                <h4 className="text-5xl w-[85%] mb-5 leading-tight md:leading-tight font-satoshibold">The Future of Payments is Here</h4>
                                <p className="text-xl font-satoshiregular text-black w-[95%] leading-relaxed md:leading-relaxed opacity-70">
