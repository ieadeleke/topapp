            ...
            <Layout>
                <>
                    <div className="w-full px-20 mt-10">
                        <div className="bg-[#003235] rounded-3xl py-10 pl-24 pr-10 max-w-[1671px]">
                            <div className="grid grid-cols-2 gap-5 items-center mx-auto max-w-[1212px]">
                                <div>
                                    ...
                                    <Image src={PeopleImg} alt="people smiling" className="w-[25%]" />
                                </div>
                                <div>
                    ...
                    <div className="bg-[#F3F3F3] py-20 w-full rounded-[35px] mt-20">
                            ...
                            <div className="bg-white flex justify-between p-10 py-8 pb-6 rounded-xl">
                                <div>
                                    <div className="flex gap-6">
                                        <div className="size-16 rounded-lg bg-[#F3F3F3]"></div>
                                        <div>
                                            ...
                                            <div className="mt-5">
                                                <div className="py-1 px-4 rounded-full w-max text-sm text-[#1967D2]"
